  ...
  function loadAd(zoneId, container) {
    ...
    fetch(adUrl)
      ...
      .catch((error) => {
        ...
        container.innerHTML =
          '<div style="display: flex; align-items: center; justify-content: center; height: 200px; background-color: #f5f5f5; border: 1px solid #eee; border-radius: 4px;">广告加载失败</div>';
      });
  }
})();
