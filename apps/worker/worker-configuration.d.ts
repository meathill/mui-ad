/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 84d93f57de805f8e60ff1af2114278aa)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    DB: D1Database;
    AI: Ai;
    MUIAD_URL: 'https://api.muiad.meathill.com';
    MUI_API_KEY: string;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'MUIAD_URL' | 'MUI_API_KEY'>> {}
}
