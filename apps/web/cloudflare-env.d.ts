/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 6f585c0a07f3c3f5b959e75016580ef6)
...
declare namespace Cloudflare {
  interface Env {
    ...
    ASSETS: Fetcher;
    NEXT_PUBLIC_SITE_URL: 'https://muiad.dev';
    NEXT_PUBLIC_ASSETS_URL: 'https://muiad.dev';
    NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
    WORKER_SELF_REFERENCE: Fetcher /* muiad-web */;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<Pick<Cloudflare.Env, 'NEXT_PUBLIC_SITE_URL' | 'NEXT_PUBLIC_ASSETS_URL'>> {}
}
