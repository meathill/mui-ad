    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">MCP-first、Self-hosted、AI 驱动的去中心化开发者推广网络</h1>
          <p className="text-xl opacity-90 mb-8">让开发者在写代码的时候，顺便就让 AI 把推广的事办了。</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="#deploy" className="px-6 py-3 bg-white text-blue-600 rounded-md font-medium hover:bg-opacity-90 transition-colors">
              开始部署
            </Link>
            <Link href="#docs" className="px-6 py-3 bg-transparent border border-white text-white rounded-md font-medium hover:bg-white hover:bg-opacity-10 transition-colors">
              查看文档
            </Link>
          </div>
        </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow">
            ...
            <div className="space-y-4">
              <div>
                ...
                <pre className="bg-gray-100 p-4 rounded-md text-sm">git clone https://github.com/yourusername/mui-ad.git</pre>
              </div>
              <div>
